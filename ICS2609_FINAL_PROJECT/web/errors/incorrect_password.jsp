    ...
    <div class="card">
        ...
        <div class="error-box">
            <c:choose>
                ...
                <c:otherwise>Invalid username or password. Please try again.</c:otherwise>
            </c:choose>
        </div>
        <p style="color:#666;margin-bottom:20px;">Please check your credentials and try again.</p>
